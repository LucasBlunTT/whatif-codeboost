...
interface HomeDocumentData {
  ...
  /**
   * Label Trailler field in *Home*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: home.label_trailler
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/core-concepts/key-text
   *
   */
  label_trailler: prismicT.KeyTextField;
  /**
   * Thumbnail Trailler field in *Home*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: home.thumbnail_trailler
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/core-concepts/image
   *
   */
  thumbnail_trailler: prismicT.ImageField<never>;
}
/**
